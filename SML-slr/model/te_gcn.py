...
class unit_gcn_3d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, A, coff_embedding=4, num_subset=3, adaptive=True, attention=True, win = 1):
...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, in_channels=3,
        ...
        #3D-TA all
        if 1:
            self.l1 = TCNC_GCN_unit(in_channels*2, 64, A, residual=False, adaptive=adaptive, attention=attention)
            ...
            self.l6 = TA_GCN3D_unit(128, 128, 50, A, adaptive=adaptive, attention=attention,inherent=0,head=1,dropout=0.0,pe=0)
            self.l7 = TA_GCN3D_unit(128, 128, 50, A, adaptive=adaptive, attention=attention,inherent=0,head=1,dropout=0.0,pe=0)
            self.l8 = TCNC_GCN3D_unit(128, 256, A, stride=2, adaptive=adaptive, attention=attention)
            self.l9 = TA_GCN3D_unit(256, 256, 25, A, adaptive=adaptive, attention=attention,inherent=0,head=1,dropout=0.0,pe=0)
            self.l10 = TA_GCN3D_unit(256, 256, 25, A, adaptive=adaptive, attention=attention,inherent=0,head=1,dropout=0.0,pe=0)
            output_emb = 256
