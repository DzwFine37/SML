...
selected_joints = {
    ...
    'face_hand' : np.concatenate(([59,62,65,68,38,53,32,35,27,24,71,75,77,80],[5,6,7,8,9,10],[91,95,96,99,100,103,104,107,108,111],[112,116,117,120,121,124,125,128,129,132]), axis=0
                                 )
}
...
def gendata(data_path, label_path, out_path, part='train', config='face_hand'):
    labels = []
    data=[]
    sample_names = []
    ...
    for line in label_file.readlines():
        ...
        data.append(os.path.join(data_path, line[0] + '_color.npy'))
        # print(line[1])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default=r'') #'train_npy/npy', 'va_npy/npy'
    parser.add_argument('--label_path', default=r'') # 'train_labels.csv', 'val_gt.csv', 'test_labels.csv'
    parser.add_argument('--out_folder', default=r'')
    parser.add_argument('--points', default='face_hand')
